...
\begin{figure}[H]
	\centering \small
	\scalebox{0.9}{\input{\figpath/globTemp.tikz}}
...
\begin{figure}[H]
	\centering \small
	\scalebox{0.9}{\input{\figpath/diff_globTemp.tikz}}
...
\begin{figure}[H]
	\centering \small
	\scalebox{0.9}{\input{\figpath/diffTemp_011.tikz}}
...
\begin{figure}[H]
	\centering \small
	\scalebox{0.9}{\input{\figpath/diffTemp_012.tikz}}
	\caption{Temperaturabhängigkeit $T_1$ bei konstanter Temperatur}
...
\begin{figure}[H]
	\centering \small
	\scalebox{0.9}{\input{\figpath/diffTemp_021.tikz}}
...
\begin{figure}[H]
	\centering \small
	\scalebox{0.9}{\input{\figpath/diffTemp_022.tikz}}
	\caption{Temperaturabhängigkeit $T_2$ bei konstanter Temperatur}
	\label{fig_Kap4_09:diffT_2}
\end{figure}
